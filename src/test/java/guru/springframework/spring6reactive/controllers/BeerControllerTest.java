...
class BeerControllerTest {
    ...
    // Test to validate that our data-validation is working, when we'll create a new Beer entity
    @Test
    void testCreateBeerBadDataCheckValidation() {
    ...
    void testUpdateBeerBadRequest() {
        Beer testBeer = BeerRepositoryTest.getTestBeer();
        testBeer.setUpc("loooooooooooooooooooooooooooooooooooooooooooooong-upc");
